...
import { Search, ArrowLeft, Mail, Lock, User, IdCard, Loader2, Eye, EyeOff } from "lucide-react";
...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.user) {
        // 🛡️ Robust Profile Creation: Ensure the profile exists with the correct role
        try {
          ...
          if (profileError) {
            console.warn("Soft Error: Background profile creation delayed, this is usually handled by a trigger.", profileError);
          }
        } catch (e) {
          console.error("Profile Upsert Crash:", e);
        }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 relative overflow-hidden bg-slate-50 dark:bg-slate-950 font-sans">
      ...
      <div className="absolute bottom-1/4 -left-20 w-96 h-96 bg-purple-500/20 rounded-full blur-[100px] animate-pulse delay-700" />
      ...
      >
        <GlassCard className="p-8 space-y-6 border-white/20 shadow-2xl backdrop-blur-xl bg-white/5">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground text-sm font-medium">Join your university's recovery network</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-xs font-black uppercase tracking-widest ml-1 text-muted-foreground">Student ID</label>
                <div className="relative">
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-black"><span className="bg-[#0f172a] px-3 text-muted-foreground tracking-widest">Or join with</span></div>
          </div>
